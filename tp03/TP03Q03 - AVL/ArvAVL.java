...
public class ArvAVL
{
  ...
  * @throws Exception Se o elemento existir.
  */
 private No inserir (No no, Instituicao x) throws Exception {
   if (no == null){
      no = new No (x);
 ...
 /**
  * Metodo para balancear a estrutura da arvore
  * @param no No de referencia
  */
 ...
 private No rotacionarEsq(No no) {
  ...
  public static void main (String [] args)
  {
   ...
   //abrir arquivo
    FileWriter arquivo = new FileWriter("628510_avl.txt");
