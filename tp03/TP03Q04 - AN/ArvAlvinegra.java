 ...
 **/
 class No {
    ...
    * Construtor da classe
    * @param elemento Conteudo do no
    * @param boolean Cor do no 
    * @param esq No da esquerda
    * @param dir No da direita
    */
   public No (Instituicao elemento, boolean cor, No esq, No dir){
 ...
 */
 ...
 public void inserir (Instituicao elemento) throws Exception{
   ...
   //Senao, se a arvore tiver um elemento
    ...
    //Senao, se a arvore tiver dois elemento (raiz e esq)
 ...
 private void balancear (No bisavo, No avo, No pai, No i){
    ...
    //Se o pai tambem e' preto, reequilibrar a arvore,
    //rotacionando o avo
      if (pai.cor == true){
      
         //4 tipos de reequilibrio e acoplamento
          ...
          //reestabelecer as cores apos rotacao
          avo.cor = false;
 ...
 /**
  * Metodo privado revursivo para inserir elemento
...
private void inserir (Instituicao elemento, No bisavo, No avo, No pai, No i) throws Exception {
   if (i == null){
      ...
      //achou um 4-no: eh preciso fragmenta-lo e
...
private No rotacaoDir(No no) {
  ...
  public static void main (String [] args)
  {
   ...
   try {
    ArvAlvinegra arvore = new ArvAlvinegra ( );
   //abrir arquivo
    FileWriter arquivo = new FileWriter("628510_alvinegra.txt");
   ...
   //iniciar repeticao
    while (nlines > 0)
     {
      ...
      try { arvore.inserir (instituicao.clone ());
       }catch (Exception x) {}
      nlines = MyIO.readInt ();
     }//fim while
    ...
    while (!sigla.equals("FIM"))
     {
      MyIO.print (sigla + " ");
      MyIO.print (arvore.pesquisar (sigla) ? "SIM\n" : "NÃO\n");
