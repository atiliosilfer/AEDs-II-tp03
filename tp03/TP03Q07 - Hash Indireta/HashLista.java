 ...
 */
 class Celula{
    ...
    * Construtores
    * */
   Celula (Instituicao elemento) {
      this.elemento = elemento;
      this.prox = null;
   }

   Celula (Instituicao elemento, Celula prox){
      this.elemento = elemento;
      this.prox = prox;
   }
 }//fim class Celula
  ...
  * */
   class Lista {
       ...
       */
      public void inserirInicio (Instituicao elemento){
      ...
      public boolean pesquisar (String x){
         ...
         for (Celula i = primeiro.prox; i != null; i = i.prox){
            if (i.elemento.getSigla().equals(x)){
               resp = true;
               i = ultimo;
            }
         }
...
public class HashLista
{
 ...
 public HashLista (int tam){
  ...
  public int h (Instituicao elemento){
      return (elemento.getCodigoMantenedora () % tam);
  }//fim h
  ...
  public static void main (String [] args)
  {
   ...
   //abrir arquivo
    FileWriter arquivo = new FileWriter("628510_hashIndireta.txt");
