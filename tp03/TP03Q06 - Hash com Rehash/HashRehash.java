...
public class HashRehash
{
 ...
 public HashRehash (int m){
  ...
  public int h (Instituicao elemento){
      return (elemento.getCodigoMantenedora () % m);
  }//fim h

  public int reh (Instituicao elemento){
      return ((elemento.getCodigoMantenedora()+1) % m);
  }
  ...
  public static void main (String [] args)
  {
   ...
   //abrir arquivo
    FileWriter arquivo = new FileWriter("628510_hashRehash.txt");
